...
20. TEXT MESSAGE (SMS) CONSENT
By providing a mobile phone number, Customer consents to receive service and account-related text messages from Jac Rentals at that number, including rental quotes, reservation and return-date reminders, delivery and pickup alerts, invoice and balance notifications, and replies to Customer's questions. Message frequency varies with rental activity, and message and data rates may apply. Customer may opt out at any time by replying STOP to any message, or reply HELP for assistance; opting out does not affect Customer's rental or payment obligations. Jac Rentals does not sell, rent, or share Customer's mobile number or texting consent with third parties or affiliates for their own marketing. Full details appear in the Jac Rentals SMS Terms & Conditions (app.jacrentals.com/sms-terms.html) and Privacy Policy (app.jacrentals.com/privacy.html).
...
21. TEXT MESSAGE (SMS) CONSENT
By providing a mobile phone number, Customer consents to receive service and account-related text messages from Jac Rentals at that number, including rental quotes, reservation and return-date reminders, delivery and pickup alerts, invoice and balance notifications, and replies to Customer's questions. Message frequency varies with rental activity, and message and data rates may apply. Customer may opt out at any time by replying STOP to any message, or reply HELP for assistance; opting out does not affect Customer's membership, rental, or payment obligations. Jac Rentals does not sell, rent, or share Customer's mobile number or texting consent with third parties or affiliates for their own marketing. Full details appear in the Jac Rentals SMS Terms & Conditions (app.jacrentals.com/sms-terms.html) and Privacy Policy (app.jacrentals.com/privacy.html).
...
export const AGREEMENT_VERSIONS = {
  // FROZEN pre-SMS-consent text — existing signings keep resolving this. Never edit.
  'rental@2026-06': { key: 'rental', title: 'Rental Account Agreement', text: `JAC RENTALS — RENTAL ACCOUNT AGREEMENT (Standard / Non-Member)
...
By signing, Customer acknowledges they have read, understood, and agree to this Rental Account Agreement.` },
  'membership@2026-06': { key: 'membership', title: 'Membership Agreement', text: `JAC RENTALS — MEMBERSHIP AGREEMENT
...
By signing, Customer acknowledges they have read, understood, and agree to this Membership Agreement.` },
  // Current — adds the §20/§21 Text Message (SMS) Consent clause (2026-07-07).
  'rental@2026-07': { key: 'rental', title: AGREEMENTS.rental.title, text: AGREEMENTS.rental.text },
  'membership@2026-07': { key: 'membership', title: AGREEMENTS.membership.title, text: AGREEMENTS.membership.text },
};
export const AGREEMENT_CURRENT = { rental: 'rental@2026-07', membership: 'membership@2026-07' };
