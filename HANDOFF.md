...
- **`drafts/units-rentals-v2.html`** (2026-06-11, AWAITING JAC'S REVIEW) — v1 + ALL of Jac's redlines applied. v1 kept for diffing only. New BINDING rules from the redline session:
  ...
  - **+Part/Task = the ANCHOR treatment** (Jac 2026-06-11): keeps the dashed add size/font but wears the anchored-card neon blue (#18b6ff ink, blue dashed border, soft ring glow) — visually elevated above ordinary adds.
