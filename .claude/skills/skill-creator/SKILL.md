...
<!--
  ...
  Note: Only SKILL.md vendored. The upstream skill also ships a helper toolkit (agents/, references/schemas.md, scripts/, eval-viewer/) used for running evals; not included here to keep the install minimal.
-->
