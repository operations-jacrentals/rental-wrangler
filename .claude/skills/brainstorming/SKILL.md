---
name: brainstorming
description: "Use ONLY when the user explicitly asks to brainstorm, design, plan, or spec a feature before building it. A collaborative dialogue that turns a rough idea into a fully-formed, approved design + spec. Do NOT auto-trigger on routine code changes."
---

<!--
  Vendored skill — attribution
  Source repo: obra/superpowers (community — Jesse Vincent 'Superpowers')
  Source URL:  https://github.com/obra/superpowers/blob/main/skills/brainstorming/SKILL.md
  Vendored into this repo on 2026-06-13. Skill BODY is unmodified; the frontmatter
  DESCRIPTION was softened from the upstream "use before ALL creative work" auto-trigger
  to OPT-IN (per Jac 2026-06-13) — the body's design-gate applies only when invoked.
  Note: Only SKILL.md vendored. The optional Visual Companion referenced at the end (skills/brainstorming/visual-companion.md plus a local browser server under scripts/) is not included.
-->
